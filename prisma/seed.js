/**
 * Seed historical returns — TSX Composite and FTSE Canada Bond Universe 1970–2024.
...
async function main() {
  ...
  console.log(`Seeded ${rows.length} rows (${Object.keys(TSX_RETURNS).length} TSX + ${Object.keys(CA_BOND_RETURNS).length} CA_BOND).`);
}
